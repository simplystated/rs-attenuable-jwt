...
///
/// ```
/// use attenuable_jwt::{protocol::{SignedJWT, PublicKey, VerificationRequirements, VerificationKeyManager}, sign::ed25519, verify::verify};
/// use std::collections::HashMap;
///
...
/// #   let jwt = attenuated.seal(Some("my-issuer"), None, Some(current_time + 60), Some(current_time)).unwrap();
/// #   (pub_key, jwt)
/// # }
///
/// #[derive(Clone)]
