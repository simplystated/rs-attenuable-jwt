...
///
/// ```
/// use attenuable_jwt::{protocol::{SignedJWT, PublicKey, VerificationRequirements, VerificationKeyManager, SecondsSinceEpoch, Issuer}, ed25519, verify::verify};
/// use std::collections::HashMap;
///
...
/// #   use attenuable_jwt::{protocol::{AttenuationKeyGenerator, SigningKeyManager}, sign::{Error, AttenuableJWT}, ed25519};
/// #
/// #   #[derive(Clone)]
/// #   struct KeyManager;
/// #
