...
///
/// ```
/// use attenuable_jwt::{SignedJWT, PublicKey, VerificationRequirements, VerificationKeyManager, SecondsSinceEpoch, Issuer, JWTHeader, JWTDecoder, ed25519, verify::{verify, Result, Error}};
/// use std::collections::HashMap;
...
mod test {
    use crate::{
        ed25519, sign::Error as SignError, verify::Error, AttenuationKeyGenerator, FullClaims,
        Issuer, JWTDecoder, JWTHeader, PrivateKey, PublicKey, SealedClaims, SecondsSinceEpoch,
